...
class NeuralNetworkLSTMForwardPropagationTest {
    ...
    private final static int SECOND_CELL_NODES_COUNT = 3;
    ...
    public void initNetwork() {
        ...
        lstmRow.getCell(1).setCellStateInput(new double[]{0.001, 0.001, 0.001});
        ...
        lstmRow.getCell(1).setHiddenStateInput(new double[]{0.001, 0.001, 0.001});
        ...
        lstmRow.getCell(1).getForgetGate().getNode(0).setCustomWeights(new double[]{0.010, 0.015, 0.020, 0.025, 0.030, 0.035, 0.040});
        lstmRow.getCell(1).getInputGate().getNode(0).setCustomWeights(new double[]{0.050, 0.055, 0.060, 0.065, 0.070, 0.075, 0.080});
        lstmRow.getCell(1).getCandidateCellState().getNode(0).setCustomWeights(new double[]{0.090, 0.095, 0.100, 0.105, 0.110, 0.115, 0.120});
        lstmRow.getCell(1).getOutputGate().getNode(0).setCustomWeights(new double[]{0.130, 0.135, 0.140, 0.145, 0.150, 0.155, 0.160});
        lstmRow.getCell(1).getForgetGate().getNode(1).setCustomWeights(new double[]{0.170, 0.175, 0.180, 0.185, 0.190, 0.195, 0.200});
        lstmRow.getCell(1).getInputGate().getNode(1).setCustomWeights(new double[]{0.210, 0.215, 0.220, 0.225, 0.230, 0.235, 0.240});
        lstmRow.getCell(1).getCandidateCellState().getNode(1).setCustomWeights(new double[]{0.250, 0.255, 0.260, 0.265, 0.270, 0.275, 0.280});
        lstmRow.getCell(1).getOutputGate().getNode(1).setCustomWeights(new double[]{0.290, 0.295, 0.300, 0.305, 0.310, 0.315, 0.320});
        lstmRow.getCell(1).getForgetGate().getNode(2).setCustomWeights(new double[]{0.330, 0.335, 0.340, 0.345, 0.350, 0.355, 0.360});
        lstmRow.getCell(1).getInputGate().getNode(2).setCustomWeights(new double[]{0.370, 0.375, 0.380, 0.385, 0.390, 0.395, 0.400});
        lstmRow.getCell(1).getCandidateCellState().getNode(2).setCustomWeights(new double[]{0.410, 0.415, 0.420, 0.425, 0.430, 0.435, 0.440});
        lstmRow.getCell(1).getOutputGate().getNode(2).setCustomWeights(new double[]{0.450, 0.455, 0.460, 0.465, 0.470, 0.475, 0.480});

        lstmRow.getCell(2).getForgetGate().getNode(0).setCustomWeights(new double[]{0.010, 0.015, 0.020, 0.025, 0.030, 0.035, 0.040});
        lstmRow.getCell(2).getInputGate().getNode(0).setCustomWeights(new double[]{0.050, 0.055, 0.060, 0.065, 0.070, 0.075, 0.080});
        lstmRow.getCell(2).getCandidateCellState().getNode(0).setCustomWeights(new double[]{0.090, 0.095, 0.100, 0.105, 0.110, 0.115, 0.120});
        lstmRow.getCell(2).getOutputGate().getNode(0).setCustomWeights(new double[]{0.130, 0.135, 0.140, 0.145, 0.150, 0.155, 0.160});
        lstmRow.getCell(2).getForgetGate().getNode(1).setCustomWeights(new double[]{0.170, 0.175, 0.180, 0.185, 0.190, 0.195, 0.200});
        lstmRow.getCell(2).getInputGate().getNode(1).setCustomWeights(new double[]{0.210, 0.215, 0.220, 0.225, 0.230, 0.235, 0.240});
        lstmRow.getCell(2).getCandidateCellState().getNode(1).setCustomWeights(new double[]{0.250, 0.255, 0.260, 0.265, 0.270, 0.275, 0.280});
        lstmRow.getCell(2).getOutputGate().getNode(1).setCustomWeights(new double[]{0.290, 0.295, 0.300, 0.305, 0.310, 0.315, 0.320});
        lstmRow.getCell(2).getForgetGate().getNode(2).setCustomWeights(new double[]{0.330, 0.335, 0.340, 0.345, 0.350, 0.355, 0.360});
        lstmRow.getCell(2).getInputGate().getNode(2).setCustomWeights(new double[]{0.370, 0.375, 0.380, 0.385, 0.390, 0.395, 0.400});
        lstmRow.getCell(2).getCandidateCellState().getNode(2).setCustomWeights(new double[]{0.410, 0.415, 0.420, 0.425, 0.430, 0.435, 0.440});
        lstmRow.getCell(2).getOutputGate().getNode(2).setCustomWeights(new double[]{0.450, 0.455, 0.460, 0.465, 0.470, 0.475, 0.480});
