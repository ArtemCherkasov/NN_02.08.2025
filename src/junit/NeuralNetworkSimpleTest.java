...
class NeuralNetworkSimpleTest {
    ...
    public void initNetwork() {
        neuralNetwork = new NeuralNetworkSimple(new int[]{FIRST_LAYER_NODES_COUNT, SECOND_LAYER_NODES_COUNT});
    ...
    void calculationLayersTest(){
        ...
        double l0n0 = neuralNetwork.getLayer(0).getNode(0).getNodeValue();
        double l0n1 = neuralNetwork.getLayer(0).getNode(1).getNodeValue();
        double l1n0 = neuralNetwork.getLayer(1).getNode(0).getNodeValue();
        double l1n1 = neuralNetwork.getLayer(1).getNode(1).getNodeValue();
        ...
        error = neuralNetwork.getErrorTotal(new double[]{FIRST_OUTPUT_FROM_NETWORK, SECOND_OUTPUT_FROM_NETWORK});
        Assertions.assertEquals(BigDecimal.valueOf(0.000035109), BigDecimal.valueOf(error).setScale(9, RoundingMode.HALF_UP));
    }
}